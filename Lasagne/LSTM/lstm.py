...
from lasagne.layers import MergeLayer, Gate, Layer
...
class LSTMLayer(MergeLayer):
    ...
    def get_output_shape_for(self, input_shapes):
        ...
        # When only_return_final is true, the third (sequence step) dimension
        # will be flattened and the shape will be (2, n_batch, num_units)
        if self.only_return_final:
            return 2, input_shape[0], self.num_units
        # Otherwise, the shape will be (2, n_batch, n_steps, num_units)
        else:
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        return T.stack([cell_out, hid_out])
